...
<div class="container">
    ...
    <form class="form-signin" action="/jobgod/index.php/Admin/Index/signin" method="post">
        <div class="form-signin-heading text-center">
            <h1 class="sign-title">Sign In</h1>
            <img src="/jobgod/Public/admin/images/login-logo.png" alt=""/>
        </div>
        <div class="login-wrap">
            <input type="text" class="form-control" placeholder="请填写你的邮箱" name="email" autofocus>
            <input type="password" class="form-control" placeholder="请填写你的密码" name="pwd">
